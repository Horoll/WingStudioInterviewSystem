<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\wamp64\www\project\wingstudiointerview/application/index\view\index\config.html";i:1505150637;s:85:"D:\wamp64\www\project\wingstudiointerview/application/index\view\public\homebase.html";i:1505205104;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<nav id="main" class="navbar navbar-default navbar-fixed-top sidebar-nav" role="navigation">
    <div class="container-fluid">
		...
		<div class="container col-md-8 col-sm-8 col-sm-offset-3 col-md-offset-3" >
			<h1>设置</h1>
			<hr>
			<form method="post" action="<?php echo url('index/config'); ?>">
				<input type="hidden" name="action" value="config">

				<div class="form-group">
					<label for="group_num"><h4>面试组数：</h4></label> <br>
					<div class="row">
						<div class="col-sm-6">
						<select class="form-control input-lg" name="group_num" id="group_num">
							<?php $__FOR_START_9602__=1;$__FOR_END_9602__=11;for($i=$__FOR_START_9602__;$i < $__FOR_END_9602__;$i+=1){ ?>
							<option <?php if(($interview['group_num'] == $i)): ?>selected = "selected"<?php endif; ?> ><?php echo $i; ?></option>
							<?php } ?>
						</select>
						</div>
					</div>
				...
				<div class="form-group">
					<label for="group_people"><h4>每组人数：</h4></label> <br>
					<div class="row">
						<div class="col-sm-6">
							<select class="form-control input-lg" name="group_people" id="group_people">
								<?php $__FOR_START_18637__=1;$__FOR_END_18637__=11;for($i=$__FOR_START_18637__;$i < $__FOR_END_18637__;$i+=1){ ?>
								<option <?php if(($interview['group_people'] == $i)): ?>selected = "selected"<?php endif; ?> ><?php echo $i; ?></option>
								<?php } ?>
							</select>
						</div>
					</div>
				...
				<br>
				<button type="submit" class="btn btn-lg btn-warning"> 设置 </button>
			</form>
		</div>
