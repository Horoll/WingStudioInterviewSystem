<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\wamp64\www\project\wingstudiointerview/application/index\view\index\choosegruop.html";i:1505190431;s:85:"D:\wamp64\www\project\wingstudiointerview/application/index\view\public\homebase.html";i:1505181408;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="sidebar-collapse">
            <ul class="nav nav-stacked">
                ...
                <li><a href="<?php echo url('Index/choosegruop'); ?>"><span class="glyphicon glyphicon-tasks"></span> 面试评分</a></li>
                ...
                <!--<li class="parent">-->
                    ...
                    <!--</a>-->
                    <!--<ul class="children collapse list-group" id="sub-item-1">-->
                ...
                <!--<li class="parent ">-->
                    ...
                    <!--</a>-->
                    <!--<ul class="children collapse list-group" id="sub-item-2">-->
                        <!--<li class="list-group-item">-->
                            <!--<a class="" href="#">-->
				...
				<div class="form-group">
					...
					<div class="row">
						...
						<select class="form-control input-lg" name="interview_group" id="interview_group">
							<?php $__FOR_START_7353__=1;$__FOR_END_7353__=0;for($i=$__FOR_START_7353__;$i < $__FOR_END_7353__;$i+=1){ ?>"}
