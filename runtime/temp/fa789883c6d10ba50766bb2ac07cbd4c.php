<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\wamp64\www\project\wingstudiointerview/application/index\view\index\rank.html";i:1505205708;s:85:"D:\wamp64\www\project\wingstudiointerview/application/index\view\public\homebase.html";i:1505205104;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<nav id="main" class="navbar navbar-default navbar-fixed-top sidebar-nav" role="navigation">
    <div class="container-fluid">
		...
		<div class="container col-md-10 col-sm-10 col-sm-offset-2 col-md-offset-2" >
			<h1>评分排名</h1>
			<hr>
			<form method="post" action="<?php echo url('index/rank'); ?>">
				...
				<div class="row">
					<div class="col-sm-6">
						<select class="form-control input-lg" name="interview_group" id="interview_group">
							<?php $__FOR_START_27961__=1;$__FOR_END_27961__=$group_num+1;for($i=$__FOR_START_27961__;$i < $__FOR_END_27961__;$i+=1){ ?>
